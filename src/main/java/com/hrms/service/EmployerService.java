...
public class EmployerService {
	...
	public EmployerService(EmployerRepository employerRepository, JobRepository jobRepository, JobService jobService) {
...
//------------------------
	...
	public List<EmployerDTO> getAllEmployers() {
		...
		employers
				.stream().map(emplyr -> new EmployerDTO(emplyr.getCompanyName(), emplyr.getEmail(),
						emplyr.getCreateTime(), emplyr.getPassword(), emplyr.getPhone(), emplyr.getWebside()))
...
//-----------------
	...
	public List<Employer> getAll() {
		...
		// ------------Alttaki methodda kullanilabilir buda ismin bas harflerine gore
		// ASC olarak siralar
